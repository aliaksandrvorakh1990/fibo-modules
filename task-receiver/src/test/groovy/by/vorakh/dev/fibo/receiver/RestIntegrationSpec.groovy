...
//
//        when:
//            def response = client.exchange(url, HttpMethod.GET, null, SolvedTaskViewModel.class)
//        then:
//            response != null
...
//            def url = "http://localhost:" + port + "/task"
//        when:
//            def response = client.exchange(url, HttpMethod.POST, request, SuccessCreatingTaskResponse.class)
//            Thread.sleep(3000L)
//        then:
//            response != null
//            response.statusCode.value() == 200
...
//            def noSolvedTaskResponse = client.exchange(taskUrl, HttpMethod.GET, null, String.class)
//        then:
//            noSolvedTaskResponse != null
//            noSolvedTaskResponse.statusCode.value() == 204
////            Thread.sleep(25000L)
//            def solvedTaskResponse = client.exchange(taskUrl, HttpMethod.GET, null, SolvedTaskViewModel.class)
